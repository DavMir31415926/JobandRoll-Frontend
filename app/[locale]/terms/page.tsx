...
import { Shield, FileText, Users, AlertTriangle, Mail, Scale } from 'lucide-react';
    ...
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold mb-4">{t('quickSummaryTitle')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="font-medium">{t('summary1')}</p>
              </div>
              <div className="text-center">
                <div className="bg-white bg-opacity-20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Shield className="h-6 w-6" />
                </div>
                <p className="font-medium">{t('summary2')}</p>
              </div>
              <div className="text-center">
                <div className="bg-white bg-opacity-20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Scale className="h-6 w-6" />
                </div>
                <p className="font-medium">{t('summary3')}</p>
              </div>
            </div>
          </motion.div>
